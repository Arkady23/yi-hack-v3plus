...
ATTENTION!!!!
=============
To date, the add-on has only been tested for the Yi Home 17CN / 27US / 47US (rootfs_y18, home_y18), Yi Outdoor (rootfs_h30, home_h30) variants. If you have a other model, one of these:  
...
ВНИМАНИЕ!!!
===========
На сегодняшний день дополнение проверено для вариантов Yi Home 17CN / 27US / 47US (rootfs_y18, home_y18), Yi Outdoor (rootfs_h30, home_h30).  Если у вас другая модель, одна из этих:  
– Yi 1080p Home (rootfs_y20, home_y20),  
– Yi Dome (rootfs_v201, home_v201),  
– Yi 1080p Dome (rootfs_h20, home_h20),  
...
Использованы модули httpd, ntpd, all.css, favicon.png и библиотека lib/* для Web-сервера и Ntpd-сервера из проекта TheCrypt0. Ссылка https://github.com/TheCrypt0/yi-hack-v4.  
