...
function go2(){
  ...
  case 'folder':
    ...
    if(dl>1){
      let fldr=d[2],pat="/record/"+d[2]+"/",
        htm="<h3 class='container'>Records&nbsp;in&nbsp;the&nbsp;folder&nbsp;"+d[2]+"</h3><hr class='tiny-margin'>\r\n"+
        "<video id=\"video\" style=\"position:fixed;left:450px;top:170px;width:720px\" controls autoplay></video>\r\n"+
        "<table><tr><th width=120 class=\"tc\">Time<br>(minute)<th width=120>File name<th width=100>Save<br>the file\r\n";
      for(i=3;i<dl;){
        htm+="<tr>\r\n"+
  ...
  default:
    ...
    if(dl<2){
      ...
      row.innerHTML="<TD colspan='2' class='tc'>There are no records";
...
function power(off){
  ...
  if(off=="off"){
    ...
    tbody.value="The camera shuts down...";
    setTimeout(function(){fstatus("The camera is ready to turn off the power")},15000);
  }else{
    go('cgi-bin/poweroff.sh?reset');
    tbody.value="The camera reboot...";
...
function sdcard(){
  ...
  fo.innerHTML="<h3>Camera&nbsp;sd-card&nbsp;records</h3><hr class='tiny-margin'>\r\n"+
	"<table>\r\n"+
	"<tr><th width=250>Date and time<th width=250>Folder\r\n"+
	"</table>\r\n";
...
function status(){
  ...
  fo.innerHTML="<div class='row'><div class='twelf columns'>\r\n"+
	"<h3 class='no-margin' id='header'>Info</h3><hr class='tiny-margin'>\r\n"+
	"<h5 class='tiny-margin strong'>System</h5><hr class='no-margin'>\r\n"+
	"<table class='u-full-width padded-table'>\r\n"+
	"<tr class='row'><td>Camera Model<td id='camera_model'>\r\n"+
	"<tr class='row'><td>Processor Model<td id='proc_model'>\r\n"+
	"<tr class='row'><td>Model Suffix<td id='suf_model'>\r\n"+
	"<tr><td>Firmware Version<td id='fw_version'>\r\n"+
	"<tr><td>Base Version<td id='home_version'>\r\n"+
	"<tr><td>Local Time<td id='local_time'>\r\n"+
	"<tr><td>Uptime<td id='uptime'>\r\n"+
	"<tr><td>Load Average<td id='load_avg'>\r\n"+
	"<tr><td>Free/Total Memory<td id='memory'>\r\n"+
	"</table>\r\n"+
	"<h5 class='tiny-margin strong'>Network</h5><hr class='no-margin'>\r\n"+
	"<table class='u-full-width padded-table'>\r\n"+
	"<tr class='row'><td>Hostname<td id='hostname'>\r\n"+
	"<tr><td>Local IP<td id='local_ip'>\r\n"+
	"<tr><td>Netmask<td id='netmask'>\r\n"+
	"<tr><td>Gateway<td id='gateway'>\r\n"+
	"<tr><td>MAC-address<td id='mac_addr'>\r\n"+
	"<tr><td>WiFi ESSID<td id='wlan_essid'>\r\n"+
	"<tr><td>WiFi Strength<td id='wlan_str'>\r\n"+
	"</table>\r\n"+
	"</div></div>\r\n";
...
function configs(){
  ...
  fo.innerHTML="<div class='row'><div class='twelve columns'>\r\n"+
	...
	"<h3 class='no-margin inline-block' id='header'>Settings</h3>\r\n"+
	"<h6 id='loading-status' class='u-pull-right loading-text'>\r\n"+
	"</div></div>\r\n"+
	"<hr class='tiny-margin'>\r\n"+
	"<div class='row'><p>In this page you can enable and disable services, change the camera hostname, disable the cloud features and more.<br></p>\r\n"+
	"</div>\r\n"+
	"<h4 class='no-margin'>General</h4><hr class='tiny-margin'>\r\n"+
	"<div class='row'><div class='twelve columns configs-switch'>\r\n"+
	"<table class='u-full-width padded-table config-table'>\r\n"+
	"<tr class='row'><td>Hostname</td><td><input class='u-full-width' type='text' placeholder='' id='HOSTNAME' onchange='delst()'><span class='switch-description'>Camera's hostname on the network.</span>\r\n"+
	"<tr class='row'><td>Timezone</td><td><select class='u-full-width' id='TZ' onchange='delst()'>\r\n"+
	"</select><span class='switch-description'>Timezone used by the Network time service.</span>\r\n"+
	"<tr class='row'><td>Disable Cloud</td><td><label class='switch small'><input type='checkbox' id='DISABLE_CLOUD' onchange='delst()'><span class='slider round'><span class='switch-text'></label><span class='switch-description'>Disabling the Yi app and all cloud features (aka offline mode).</span>\r\n"+
	"<tr class='row'><td>Recording without Cloud<td><label class='switch small'><input type='checkbox' id='REC_WITHOUT_CLOUD' onchange='delst()'><span class='slider round'><span class='switch-text'></label><span class='switch-description'>Enable recording on the SD card even with the Cloud features disabled. (It takes effect only if the \"Disable Cloud\" option is enabled).</span>\r\n"+
	"<tr class='row'><td>Proxychains-ng<td><label class='switch small'><input type='checkbox' id='PROXYCHAINSNG' onchange='delst()'><span class='slider round'><span class='switch-text'></label><span class='switch-description'>Proxychains-ng &ndash; is a way to bypass the region restrictions imposed by Yi when using a Chinese camera outside China.</span>\r\n"+
	"</table>\r\n"+
	"</div></div>\r\n"+
	"<h4 class='no-margin'>Advanced</h4><hr class='tiny-margin'>\r\n"+
	"<div class='row'><div class='twelve columns configs-switch'>\r\n"+
	"<table class='u-full-width padded-table config-table'>\r\n"+
	"<tr class='row'><td>RTSP</td><td><label class='switch small'><input type='checkbox' id='RTSP' onchange='delst()'><span class='slider round'><span class='switch-text'></label><span class='switch-description'>Enable or disable RTSP-server.</span>\r\n"+
	"<tr class='row'><td>FTP</td><td><label class='switch small'><input type='checkbox' id='FTPD' onchange='delst()'><span class='slider round'><span class='switch-text'></label><span class='switch-description'>Enable or disable FTP-server.</span>\r\n"+
	"<tr class='row'><td>Telnet<td><label class='switch small'><input type='checkbox' id='TELNETD' onchange='delst()'><span class='slider round'><span class='switch-text'></label><span class='switch-description'>Enable or disable Telnet server.<br><span class='strong'>WARNING: Telnet is NOT a secure protocol and should be avoided. Enable only if it's really necessary.</span></span>\r\n"+
	"<tr class='row'><td>NTPD<td><label class='switch small'><input type='checkbox' id='NTPD' onchange='delst()'><span class='slider round'><span class='switch-text'></label><span class='switch-description'>Enable or disable the Network time service. This is required to sync the time on the camera if the cloud features are disabled.</span>\r\n"+
	"<tr class='row'><td>HTTPD<td><label class='switch small'><input type='checkbox' id='HTTPD' onchange='delst()'><span class='slider round'><span class='switch-text'></label><span class='switch-description'>Enable or disable the Web-server.<br><span class='strong'>WARNING: If disabled, you won't have access to this page.</span></span>\r\n"+
	"</table>\r\n"+
	"</div></div>\r\n"+
	"<div class='align-right'><span class='strong'>The changes take effect after you save the settings and reboot the camera.</span>\r\n"+
	"</div><br>\r\n"+
	"<div class='u-pull-right'><div class='padded-right save-text' id='save-status'></div><input class='button-primary' type='button' id='button-save' value='Save Settings' onclick=\"set_conf()\">\r\n"+
	"</div>\r\n"+
	"</div></div>\r\n";
...
function reboot(){
  ...
  fo.className="container";
  fo.innerHTML="<div class='row'><div class='twelf columns'>\r\n"+
	"<h3 class='no-margin' id='header'>Reboot or power off the camera</h3><hr class='tiny-margin'>\r\n"+
	"<div class='row'><div class='twelve columns configs-switch'>\r\n"+
	"<table class='u-full-width padded-table config-table'>\r\n"+
	"<tr class='row'><td>Status<td><input class='u-full-width' type='text' placeholder='' readonly='' data-key='STATUS' id='STATUS' value='The camera is on'>\r\n"+
	"</table>\r\n"+
	"</div></div><br>\r\n"+
	"<div class='u-pull-right pl'>\r\n"+
	"<input class='button-primary' type='button' id='button-off' value='Power off the camera' onclick=\"power('off')\">\r\n"+
	"</div>\r\n"+
	"<div class='u-pull-right'>\r\n"+
	"<input class='button-primary' type='button' id='button-reboot' value='Reboot' onclick=\"power('reset')\">\r\n"+
	"</div>\r\n"+
	"</div></div>\r\n";
}
