...
var o=document.getElementById(id2);
  try{
    ...
    case 2:
      o.innerHTML="Запрос принят. Ждите...";
      break;
    case 3:
      o.innerHTML="Получение данных...";
      break;
    case 4:
      if(req.status==200){
        o.innerHTML="";
        ...
        o.innerHTML="Не удалось получить данные: "+req.statusText;
      }
    }
  }catch(e){
    o.innerHTML="Ошибка в функции go2(): "+e.name;
  }
}
